...
env_sampling(src_dir, var_dir, range_dir, region_dir, occ_dir, bg_dir)
```
...
After completing these steps, the occurrence and background samples are ready for modeling. We are confident that the occurrences and environmental variables have been thoroughly examined and properly processed.
