...
description: |
  An example of HPC hosted at the UCSB Center for Scientific Computing at CNSI
author:
  - name: Lei Song
...
[1-64]: dual 20 cores, ~187G RAM
[56, 64]: with 2 hours time limit for jobs
[101-104]: dual 20 cores with 1.4T RAM (1376G)
[111-113,115-125]: 4 NVIDIA 64-bit V100 GPUs 40GB GPU RAM, dual 12 cores ~187G RAM
...
```
conda install -c conda-forge r-fastshap r-optparse r-readxl r-rgbif r-here r-devtools r-proc r-randomforest
conda install -c r r-virtualspecies
```

### Step 4: Install some public GitHub repo

It is not recommended to mix-use conda-forge and base R package installation due to potential risks, but it does work. Other GitHub packages can be installed with the same way.
...
Follow the [tutorial](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account) to add the server's SSH key to GitHub Authentication keys so you can clone private repositories when necessary.
